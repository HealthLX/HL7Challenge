<%@ page import="java.net.URL, javax.servlet.http.HttpServletRequest, oauth2.common.ConsumerRegistration" %>

<%
    ConsumerRegistration reg = (ConsumerRegistration)request.getAttribute("newClient");
    URL requestURL = new URL(request.getRequestURL().toString());
    String socialAppPath = requestURL.getProtocol() + "://" + requestURL.getHost() + ":" + "${social.port}";
%>
...
<p>
<big><big>
Calendars of Social.com users can be accessed at <b><%= socialAppPath %>/social/thirdparty/calendar</b><br/> using an OAuth access token.
HTTP GET and POST verbs can be used.
</p>
<br/>
<p>
Please follow this <a href="<%= socialAppPath %>/social/forms/registerUser.jsp">link</a> to get a user registered with Social.com
</p>
</big></big>
</div>
</body>
