<%@ page import="java.net.URL, javax.servlet.http.HttpServletRequest" %>

<%
    URL requestURL = new URL(request.getRequestURL().toString());
    String httpProtocol = requestURL.getProtocol();
%>
...
<br/>
     <form action="/oauth/register/registerProvider"
       ...
       <table>    
        ...
        <tr>
            ...
            <td>
              <input type="text" size="50" name="appURI" value="<%= httpProtocol %>://localhost:${reservations.port}/reservations/service"/>
            </td>
        </tr>
        <tr>
