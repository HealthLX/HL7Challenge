<%@ page import="java.net.URL, javax.servlet.http.HttpServletRequest, oauth2.service.UserAccount, oauth2.common.Calendar, oauth2.common.CalendarEntry" %>
<%
    URL requestURL = new URL(request.getRequestURL().toString());
    String reservationsPath = requestURL.getProtocol() + "://" + requestURL.getHost() + ":" + "${reservations.port}";
...
<tr>
<td><big><big><big>Alias</big></big></big></td><td><big><big><%= account.getAccountAlias() %></big></big></td>
</tr>
<tr>
...
<p>
Please follow this <a href="<%= reservationsPath %>/reservations/forms/reservation.jsp">link</a> to find out more.
</p>
</big></big>
</div>
</body>
